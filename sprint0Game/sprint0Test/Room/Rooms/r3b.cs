...
{
    public class r3b : AbstractRoom
    {
        public r3b(RoomData data)
        {
            RoomID = data.RoomID;
        ...
        public override void Initialize()
        {
            ...
            {
                Enemies.Add(EnemyManager.Instance.CreateKeese(new Vector2(300, 200)));
                Enemies.Add(EnemyManager.Instance.CreateKeese(new Vector2(400, 200)));
